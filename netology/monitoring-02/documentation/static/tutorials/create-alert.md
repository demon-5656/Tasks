...
You will need to create an incoming webhook integration for Slack before starting this tutorial. Use the webhook URL provided by your own Slack workspace.
